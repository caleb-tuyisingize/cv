...
export default function Header() {
  return (
        <>
            <div id='hider' className="card min-h-[calc(89vh-5rem)] rounded-br-[30px] lg:h-[calc(99vh-5rem)] xl:h-[calc(99vh-5rem)] lg:mt-10 xl:mt-10 px-2 lg:px-12 xl:px-12 w-full content-center dark:bg-gray-900">
